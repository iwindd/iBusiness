...
import { DialogActions, DialogTitle, Button, DialogContent, TextField, InputAdornment, ButtonGroup, FormGroup, FormControlLabel, Checkbox } from '@mui/material';
  ...
  return (
    <form onSubmit={onSubmit} >
      ...
      <DialogContent className=' space-y-2'>
        ...
        <FormGroup>
          <FormControlLabel control={<Checkbox value={check} onChange={(e) => setCheck(e.target.checked)}/>} label="ออกใบเสร็จ" />
        </FormGroup>
      </DialogContent>
      <DialogActions>
